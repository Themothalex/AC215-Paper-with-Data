            ...
            <div className="flex items-center justify-center h-full text-gray-500">
                ...
                {selectedResult && (
                    <div className="w-80 bg-gray-100 min-h-screen p-4">
                        <h2 className="text-xl font-bold mb-4">Datasets Details:</h2>
                        <div className="space-y-4">
                            {[1, 2, 3, 4, 5, 6].map((num) => (
                                <div key={num} className="bg-white p-4 rounded-lg shadow">
                                    <p className="text-sm space-y-1">
                                        <span className="font-semibold">{num}. name:</span> Relative income levels<br/>
                                        <span className="font-semibold">type:</span> Categorical<br/>
                                        <span className="font-semibold">categories:</span> [Low income, Middle income, Upper income]
                                    </p>
                                </div>
                            ))}
                        </div>
